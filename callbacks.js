...
console.log(
  "Adding three: " + addThree(10) + " and added three is " + addedThree
);
...
console.log(
  "Reduced filtered array: " + myarray.filter(greaterThan2).reduce(addB, 0)
);
...
console.log(
  "Challenge 7b: " +
    intersection2([5, 10, 15, 20], [15, 88, 1, 5, 7], [1, 10, 15, 5, 20])
);
// should log: [5, 15]
