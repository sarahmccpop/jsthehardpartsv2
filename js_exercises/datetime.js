...
function calculateHoursWorked(dayWorked) {
  ...
  switch (dayWorked) {
    case day.MONDAY:
      ...
      console.log(
        "Hours worked on Monday " + millisecondsToHours(hoursWorked)
      ) + " hours";
      break;
    default:
...
function calculateHoursWorkedMinusGivenTime() {
  const hoursWorkedMinusGivenTime =
    finishedWork -
    beganWork -
    timeGivenAfterWrap -
    timeGivenPreCalltime -
    lunchbreak;
...
function calculatePreCallPayment() {
  ...
  console.log(
    "Payabale precall " + millisecondsToMinutes(payablePreCall) + " minutes"
  );
}
...
*/
console.log(
  "Precall was " + calculatePreCallTotalWorked(calltime) + " minutes"
);
